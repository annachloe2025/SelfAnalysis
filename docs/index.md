...
- [自己紹介](01_自己紹介/index.md) — 育ちと、47歳までの違和感と、気づきの話
- [3つの特性（生得的）](02_私の特性/01_三本柱.md) — 私を理解する鍵となる3つの生得的特性

時間がある人へ。次の順で読むと体系的に追える。

1. [私の特性](02_私の特性/index.md) — 自己紹介、3つの生得的特性の概観、派生特性のマップ
2. [性同一性障害](03_性同一性障害/index.md) — 関連エピソードからの分析
3. [HSP](04_HSP/index.md) — 関連エピソードからの分析
4. [承認欲求](05_承認欲求/index.md) — 関連エピソードからの分析
5. [仮説と理論](06_仮説と理論/index.md) — 自家製仮説の体系
6. [作品と趣味](07_作品と趣味/index.md) — 嗜好データと技術スタック
7. [今とこれから](08_今とこれから/index.md) — 現在地と展望
8. [付録](09_付録/index.md) — 履歴書、簡易年表
...
派生する特性、思考、思想、社会との衝突、人生の選択は、すべてこの三つの特性から説明できる。これが私の自己理解の到達点だ。

詳細は [3つの特性（生得的）](02_私の特性/01_三本柱.md) 参照。
